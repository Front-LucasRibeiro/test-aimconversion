function priceDiscountValue() {
  ...
  document.querySelector('[data-testid="mod-productprice"] [data-testid="price-default"] > span').innerHTML = `(${discountValue} de <strong>desconto</strong>)`;
}
